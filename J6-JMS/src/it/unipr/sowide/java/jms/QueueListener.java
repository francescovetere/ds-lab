...
/**
 *
 * Class providing an implementation of a receiver that uses a queue listener.
 *
 **/
...
public class QueueListener implements MessageListener {
	...
	public QueueListener() {
		try {
			...
			ActiveMQConnectionFactory cf = new ActiveMQConnectionFactory(QueueListener.BROKER_URL);
